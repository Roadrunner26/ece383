...
begin
    ...
    base_plus_delta_x_offset <= signed_base + delta_x_offset(23 downto 8); -- TODO: Compute the base + delta*offset to get the interpolated value; -- Q16.0 + [Q17.8 sliced to Q16.0]
