...
// Command     : write_verilog -force -mode synth_stub -rename_top Final_Project_axi_smc_0 -prefix
//               Final_Project_axi_smc_0_ Final_Project_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Final_Project_axi_smc_0,bd_04e3,{}" *) (* CORE_GENERATION_INFO = "Final_Project_axi_smc_0,bd_04e3,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_04e3,Vivado 2024.2" *) 
module Final_Project_axi_smc_0(aclk, aresetn, S00_AXI_awaddr, S00_AXI_awprot, 
