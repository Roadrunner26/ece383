...
HD_PWD='C:/Users/Grantham.Zimmerman/Desktop/ece383-hw2/ece383-hw2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw2.tcl
