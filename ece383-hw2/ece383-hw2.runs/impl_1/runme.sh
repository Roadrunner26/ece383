...
HD_PWD='C:/Users/Grantham.Zimmerman/Desktop/ece383-hw2/ece383-hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw2.tcl -notrace
